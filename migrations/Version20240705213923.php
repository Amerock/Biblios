 ...
 */
final class Version20240705213923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD livre_id INT NOT NULL, ADD status VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP livre_id, DROP status');
    }
}
